...
class AntiBot {
	...
	public function html($count = false) {
		...
		$elements = array(
			...
			'<input class="display-none" type="text" name="%name%" value="%value%">',
			'<input class="display-none" type="text" value="%value%" name="%name%">',
			'<span class="display-none"><input type="text" name="%name%" value="%value%"></span>',
			'<div class="display-none"><input type="text" name="%name%" value="%value%"></div>',
			'<div class="display-none"><input type="text" name="%name%" value="%value%"></div>',
			'<textarea class="display-none" name="%name%">%value%</textarea>',
			'<textarea name="%name%" class="display-none">%value%</textarea>'
		);
